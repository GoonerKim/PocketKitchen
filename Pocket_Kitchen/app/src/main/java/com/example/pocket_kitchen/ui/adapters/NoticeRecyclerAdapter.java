...
public class NoticeRecyclerAdapter extends RecyclerView.Adapter<NoticeRecyclerAdapter.ViewHolder> {
    ...
    public NoticeRecyclerAdapter(Context context, String uid) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new NoticeRecyclerAdapter.ViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_cardview, null));
    }
                ...
                if (list.getUid().equals(uid)) { //관리자인지 확인
                    ...
                    builder.setItems(select, (dialog, pos) -> {
                        if (select[pos].equals("편집")) {
                            Intent intent = new Intent(context, My_Recipe_add_notice.class);
